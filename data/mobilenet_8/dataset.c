...
int8_t conv1_filter_3x3[9] __attribute__((aligned(32*NR_LANES))) =
{
    1, 0, -1,
    1, 0, -1,
    1, 0, -1
...
int8_t pw_before_weights[PW_CH] __attribute__((aligned(32*NR_LANES)));

int8_t pw_before_bias[PW_CH] __attribute__((aligned(32*NR_LANES)));


int8_t dw_filters[PW_CH * 9] __attribute__((aligned(32*NR_LANES)));


int8_t pw_after_weights[PW_CH * PW_CH] __attribute__((aligned(32*NR_LANES)));

int8_t pw_after_bias[PW_CH] __attribute__((aligned(32*NR_LANES)));


int8_t fc_weights[FLAT_SIZE * FC_OUT] __attribute__((aligned(32*NR_LANES)));

int8_t fc_bias[FC_OUT] __attribute__((aligned(32*NR_LANES)));
