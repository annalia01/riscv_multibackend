...
#define POOL1_OUT_W (CONV1_OUT_W / 2)   // 7

#define CONV2_OUT_H (POOL1_OUT_H - 2)    // 5
#define CONV2_OUT_W (POOL1_OUT_W - 2)    // 5

#define POOL2_OUT_H (CONV2_OUT_H / 2)    // 2
#define POOL2_OUT_W (CONV2_OUT_W / 2)    // 2

#define FLAT_SIZE (POOL2_OUT_H * POOL2_OUT_W)   // 4
#define FC_OUT 10


int8_t input_image[IN_H * IN_W]
...
int8_t fc_weights[FLAT_SIZE * FC_OUT]
    __attribute__((aligned(32*NR_LANES)));

int8_t fc_bias[FC_OUT]
    __attribute__((aligned(32*NR_LANES)));
