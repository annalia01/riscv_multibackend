...
int32_t fc1_w[FC1_OUT * FLAT_SIZE] __attribute__((aligned(32*NR_LANES)));
int32_t fc1_b[FC1_OUT]              __attribute__((aligned(32*NR_LANES)));

int32_t fc2_w[FC2_OUT * FC1_OUT] __attribute__((aligned(32*NR_LANES)));
int32_t fc2_b[FC2_OUT]            __attribute__((aligned(32*NR_LANES)));

int32_t fc3_w[FC3_OUT * FC2_OUT] __attribute__((aligned(32*NR_LANES)));
int32_t fc3_b[FC3_OUT]            __attribute__((aligned(32*NR_LANES)));
