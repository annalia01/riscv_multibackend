...
extern uint8_t M;
extern uint8_t N;
extern uint8_t cols_b;

extern uint8_t VALUES[] __attribute__((aligned(32 * NR_LANES)));
extern uint8_t col_idx[] __attribute__((aligned(32 * NR_LANES)));
extern uint8_t B[] __attribute__((aligned(32 * NR_LANES)));
extern uint8_t C[] __attribute__((aligned(32 * NR_LANES)));
